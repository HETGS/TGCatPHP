...
<?php
print "<div id='page' style='padding-top:12px;'>\n";
...
print "<div style='position:fixed;top:30px;background:#ffffbb;color:#884400;padding-top:1px;width:100%;border:0px;border-bottom:1px solid #222222;text-align:center;font-size:12px;font-weight:bold;font-style:italic;opacity:0.85;filter:Alpha(opacity=85);'> ---- currently viewing " . getNiceTableNameFromCode( $tableCode ) . " table ---- </div>";
